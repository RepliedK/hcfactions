...
public class FakeInventories implements Listener {
    ...
    public static void load() {
        ...
        FAKE_BLOCKS.put(InventoryType.WORKBENCH, new SingleFakeBlock(BlockID.CRAFTING_TABLE, InventoryType.CRAFTING.getDefaultTitle()));
